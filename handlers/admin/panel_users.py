...
_ACTION_TITLES = {
    ...
    # на счету или квоты Qwen и обнуление вечного счётчика «потрачено».
    "balance":    ("💵", "счёт/квота"),
    "cost_zero":  ("♻️", "ОБНУЛЁН СЧЁТЧИК РАСХОДА"),
    # Тумблер «⬇️ САМООБНОВЛЕНИЕ» в /adm (2026-07-27): бот сам забирает
    # новый код с GitHub раз в 10 минут.
    "autoupdate": ("⬇️", "самообновление"),
    # Тумблер «🚨 ТРЕВОГА (Днепр)» в /adm (2026-07-30): слежение за воздушной
    # тревогой, сообщения владельцу в личку.
