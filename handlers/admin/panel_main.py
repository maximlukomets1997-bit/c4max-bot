...
# Раскладку выбрал Максим из трёх макетов: «строго парами», без одиночных
# кнопок. Ценой этого сдвинулись пары Gemini (июльский порядок «по столбцам»
# больше не читается) и Qwen3.8 Max встала в ряд с Gemini 3.1 Flash-Lite —
# ЕДИНСТВЕННЫЙ ряд, где рядом стоят разные провайдеры. Это осознанный выбор
# ровной сетки, а не недосмотр: свободных мест в парах больше не было.
_MODEL_BUTTON_ROWS = [
    ["gemini-3.7-flash", "gemini-3.6-flash"],
    ["gemini-3-flash-preview", "gemini-3.5-flash"],
    ["gemini-3.1-flash-lite", "qwen3.8-max"],
