...
def _build_proactive_parts(chat_id: int, bot_id: int, trigger_text: str,
    ...
    # ⚠️ СТРОКИ «Ты: уже видел, решил промолчать» ЗДЕСЬ БОЛЬШЕ НЕТ (заведена и
    # убрана 2026-08-11 по решению Максима). Она подписывалась как «Ты:», то
    # есть выглядела РЕПЛИКОЙ БОТА рядом с его настоящими репликами — модель
