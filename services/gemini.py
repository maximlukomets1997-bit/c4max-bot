...
def _last_news_block() -> str:
    ...
    решение Максима). Собирается в двух местах: обычный ответ (ask_gemini —
    и в группе, и в личке) и режим «Сам в разговор» (_build_proactive_parts,
    а через него — оба его пути, текстовый и медийный). В голосовые и видео
    (ask_gemini_audio / ask_gemini_video) НЕ добавлена: у них облегчённый
    запрос без справок вообще — там нет и базы знаний.
