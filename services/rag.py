...
# индекс остался неполным (36 из 56). Секунда вместо полсекунды — решение
# Максима 2026-07-19 (надёжность важнее скорости, пересборка всё равно в фоне).
_INDEX_PAUSE_SEC = 1.0
