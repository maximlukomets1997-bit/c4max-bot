...
| `quiz/questions.json` | 144 КБ данных, 237 вопросов; JSON с отступом в ОДИН пробел и переводами строк CRLF — пересобираешь файл скриптом, сверяй байт в байт, иначе получишь разницу на все 2800 строк. Читается только на кнопку «📥 Загрузить мои вопросы» |
