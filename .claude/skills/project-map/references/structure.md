...
Снимок от 2026-08-30 по коду версии v4.91: таблица пересобрана скриптом и
...
## `web/` — веб-админка (30.08.2026, этапы 0–5: перенос завершён)
...
| `web/routes.py` | 685 | `ROUTES` — единственный список адресов; `build_app`, `index`, `apply`, `prompts`, `kb`, `quiz`, `users`, `user_card`, `system`, `download`, `enter`, `exit_`, `health` |
